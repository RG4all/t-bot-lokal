...
5. **CI-Dateien:** `ci/quality.yml` wird vom Maintainer nach `.github/workflows/` übernommen (siehe `ci/README.md`); Workflow-Änderungen dort immer auf beide Kopien anwenden.
