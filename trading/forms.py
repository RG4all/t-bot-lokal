...
class ConfigurationForm(forms.ModelForm):
    class Meta:
        ...
        labels = {
            ...
            "has_live_credentials": "Live-API-Schlüssel konfiguriert",
        ...
        help_texts = {
            ...
            "has_live_credentials": "Dokumentationsstatus: zeigt an, dass echte Börse-API-Schlüssel als Umgebungsvariablen konfiguriert wurden. Der Schalter aktiviert den Echtzeithandel nicht – live gehandelt wird nur, wenn die Schlüssel beim Container-Start gesetzt sind (in der Datenbank stehen nie Schlüssel).",
