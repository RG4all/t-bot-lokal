...
- Keine Code-, Settings-, Modell- oder Migrationsänderung, keine neuen Umgebungsvariablen. Bestehende Konfigurationen, laufende Bots und gespeicherte Backtests bleiben unverändert gültig; nach dem Deploy `/health/` auf **2.4.19** prüfen. Auslieferung über den Dokumentations-PR dieses Standes.
