...
**Nachprüfung 2.4.15:** Auslöser war das Indikator-Refactoring (Prompt 18 / Audit §4.3, [CODE-18](CODE-18-indicator-dedup.md)); die Einstellungen blieben unverändert. `CSRF_COOKIE_HTTPONLY = True` steht weiterhin explizit und DEBUG-/Render-unabhängig außerhalb des nicht-DEBUG-Blocks (`trading_bot_project/settings.py`), und alle 11 CSRF-Cookie-Tests bestehen zusammen mit den 28 neuen Indikator-Tests (277 Tests gesamt). SEC-05 bleibt **Fixed**; der hier beschriebene nosniff-Befund bleibt ebenfalls **Fixed** (Fix-Commit [`a2e6c4bd`](https://github.com/RG4all/t-bot-lokal/commit/a2e6c4bd18fbcf1649efa1af6ec1822501f93958), Release 2.4.6).
