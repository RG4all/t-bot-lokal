...
- Einzelne Befunde, Releases und Nachprüfungen: [docs/findings/](docs/README.md#findings) · verbindlicher Gesamtstatus: [Security-Review](docs/SECURITY_REVIEW_2.4.4.md).
...
- [Benutzerhandbuch](docs/MANUAL.md) (wird in der App unter `/help/` gerendert) · [Backtesting](docs/backtesting.md)
- [Lokale Entwicklung, Betrieb, QA, Render-Deployment](docs/LOCAL_DEVELOPMENT.md) · [FAQ und Secret-Rotation](docs/FAQ.md) · [Tailscale-Fernzugriff](docs/REMOTE_ACCESS_TAILSCALE.md) · [Caddy-Reverse-Proxy](docs/caddy-proxy-docker-config-manual.md)
- [Security-Review (aktuell)](docs/SECURITY_REVIEW_2.4.4.md) · [Findings](docs/README.md#findings) · [Architektur-Entscheidungen](docs/BACKTESTING_STUDY.md) · [Changelog](docs/CHANGELOG.md)
